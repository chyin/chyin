window.onload = function(){
	...
	var tableOffset = getTop(divTable);
	// 滚动触发
	window.onscroll = function(){
		//console.log(divTable.offsetHeight);
		var scrotop = document.documentElement.scrollTop || window.pageYOffset || document.body.scrollTop;
		//console.log(scrotop);
		if(scrotop > tableOffset && scrotop < tableOffset + divTable.offsetHeight){
	...
	function buttonReady(){
		var buttonArray = ["chineseUp","chineseDown","mathUp","mathDown","englishUp","englishDown","totalUp","totalDown","chinesefUp","chinesefDown","mathfUp","mathfDown","englishfUp","englishfDown","totalfUp","totalfDown"];
